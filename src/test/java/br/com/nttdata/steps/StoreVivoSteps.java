...
public class StoreVivoSteps {
    ...
    public void selecionoOPrimeiroProdutoExibido() {
        new PageCelulares(DriverManager.getDriver()).escolherOSegundoAparelho();
    ...
    public void verificoOPrecoDoProduto() {
        precoProduto = new PageProdutos(DriverManager.getDriver()).retornarPrecoDoProduto();
    ...
    public void oCarrinhoDeveConterOItemAdicionado() {
        boolean isVisible = new PageCarrinho(DriverManager.getDriver()).verificaProdutoNoCarrinho();
